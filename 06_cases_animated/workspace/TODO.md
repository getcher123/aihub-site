...
<todo id="gauge-animation">
Animate gauge fill on mount
Add CSS or JS animation so the SVG arcs and speedometer needles animate from 0 to their target value on initial render.
</todo>
<todo id="a11y-cards">
Add accessibility attributes
Cards lack interactive semantics — add `role`, `aria-label`, and keyboard focus if they become clickable.
</todo>

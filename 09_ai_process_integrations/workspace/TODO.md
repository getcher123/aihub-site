...
<todo id="add-entrance-animations">
Add entrance animations to integration cards
Stagger fade-up animations on each IntegrationCard for a polished load experience
</todo>
<todo id="mobile-nav">
Add mobile navigation/header
The page currently has no navigation — consider a responsive header with logo and menu
</todo>
<todo id="a11y-pass">
Accessibility audit
Add proper aria-labels, ensure color contrast meets WCAG AA, verify keyboard navigation through all interactive elements
</todo>

...
<todo id="hover-desktop">
Add hover glow effects to desktop cards too
The desktop absolute-positioned cards currently have no hover — match the mobile hover style.
</todo>
<todo id="a11y-focus">
Add keyboard focus-visible styles to roadmap cards
Cards should show visible focus ring for accessibility when tabbed.
</todo>

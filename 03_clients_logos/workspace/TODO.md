...
<todo id="test-responsive">
Verify responsive layout on 375px, 768px, and 1920px viewports
Check that all 6 client blocks render correctly, hover glows work, and no horizontal scroll appears below lg breakpoint.
</todo>

<todo id="add-more-sections">
Add additional page sections (hero, footer, services)
The Home page currently only has the "Clients" block — consider building out the full page layout.
</todo>

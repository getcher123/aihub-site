...
**Status:** Active
**Description:** Hero sections use Flexbox with `flex-col lg:flex-row`, relative units (`vw`, `%`, `rem`), and Tailwind responsive prefixes. Avoid `min-w-[px]` and absolute pixel positioning for layout.
**Rationale:** The Anima export used fixed 1920px layout; this pattern ensures all viewports work.

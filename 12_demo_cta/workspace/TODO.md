...
<todo id="add-meta-og">
Add Open Graph & SEO meta tags
The page has a generic title and no description/OG tags — important for sharing and search indexing.
</todo>

<todo id="mobile-cta-border">
Verify CTA decorative border SVG on small screens
The `rectangle-12.svg` overlay is sized at 330×117px — confirm it doesn't clip or misalign below 375px.
</todo>

<todo id="add-more-sections">
Build out remaining page sections
Currently only a hero exists; the landing page likely needs features, testimonials, and a footer.
</todo>

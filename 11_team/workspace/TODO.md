...
<todo id="add-scroll-animations">
Add scroll-triggered entrance animations for team cards
Fade-up or stagger cards as they enter the viewport using IntersectionObserver or framer-motion
</todo>

<todo id="optimize-images">
Optimize team member images
Consider adding lazy loading and srcSet for different screen densities
</todo>

<todo id="accessibility-pass">
Accessibility improvements
Add aria-labels, proper heading hierarchy, and keyboard focus states on cards
</todo>

...
Add form validation and phone mask
The phone input should enforce a format (e.g. +7 XXX XXX-XX-XX) and show inline errors on invalid submit.
</todo>

<todo id="form-submit-feedback">
Add submit feedback (loading state / success message)
Currently `handleSubmit` does nothing — wire it to an API or at least show a confirmation toast.
</todo>

<todo id="meta-seo">
Add SEO meta tags and Open Graph data
The page title is generic ("Anima Project") and has no description/OG tags for sharing.
</todo>

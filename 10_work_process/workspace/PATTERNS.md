...
### Responsive Split-Layer Section

**Category:** Architecture
**Status:** Active
**Description:** For sections with strict desktop positioning, keep a desktop-only absolute layer and create a dedicated mobile layer.
**Implementation:**
Use `hidden lg:block` for fixed desktop composition and `lg:hidden` for mobile-first stacked content.
**Rationale:** Preserves desktop fidelity while avoiding fragile coordinate scaling on mobile.
